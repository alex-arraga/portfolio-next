...
function Footer({ otherClasses }: FooterProps) {
    return (
        <footer className={`flex flex-col text-black-100 border-t border-b-gray-100 ${otherClasses}`} >
            <div className='flex max-md:flex-col flex-wrap justify-between gap-5 p-4 sm:p-6 md:p-8 xl:p-10'>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center flex-wrap border-t border-gray-100 p-4 sm:p-6">
