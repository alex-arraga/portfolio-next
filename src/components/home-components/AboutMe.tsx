    ...
    return (
        <div className="flex justify-end w-full h-full mb-2 md:mb-6 xl:mb-10">
            <div className="p-4 md:p-6 xl:p-10 w-full md:w-2/3">
                <h1 className="my-4 md:my-6 xl:my-10 font-bold text-[16px] md:text-[18px] xl:text-[36px] text-gray-100" > Hola <span className="text-orange-200 capitalize">{fullNameUser ? fullNameUser : userName ? userName?.replace(/[0-9-_]+/g, ' ') : 'internauta'}</span>, <br /> soy Alex! 😁</h1>
